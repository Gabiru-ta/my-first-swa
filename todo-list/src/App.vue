  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        <h1 class="ui inverted header"> TESTE Todo List com Vue.js 3</h1>
        <h2 class="ui inverted header">Gabriel Batista
          <div class="sub header">Aprendiz</div>
        </h2>
        <h3 class="ui inverted header">Brasília, Brasil - 2020</h3>
